...
<!-- 2023-01-31 DDNS 항목에 access_log출력을 위한 항목 출력으로 body의 글꼴 사이즈를 기존 1em (top.jsp) 에서 0.875em으로 변경 -->
		...
		<tr>
			<td>
				<table border="0" width="100%" style="border-collapse: collapse;">
					...
					<!--<tr height="30">
									...
									<tr align="center">
										...
										<td width="9%" class="select title font1"><span style="cursor: pointer;"
												onclick="location.href='/PushAdmin/${url }?type=${type }&auth=${auth }&service_no=${service_no }&sort=p2p_priority&direction=${direction == 'desc' ? 'asc' : 'desc' }&search_type=${search_type }&search_word=${search_word }'">P2P
												우선순위</span></td>
										<td width="8%" class="select title font1"><span style="cursor: pointer;"
							...
							<td width="9%" class="select title font1"><span style="cursor: pointer;"
									onclick="location.href='/PushAdmin/${url }?type=${type }&auth=${auth }&service_no=${service_no }&sort=cms_access_id&direction=${direction == 'desc' ? 'asc' : 'desc' }&search_type=${search_type }&search_word=${search_word }'">[🖥️]CMS ACCESS</span></td>
						</tr>
						<tr align="center">
					...
					<td class="select title font1">
						<span style="cursor: pointer;" onclick="location.href='/PushAdmin/${url }?type=${type }&auth=${auth }&service_no=${service_no }&sort=device_accesslog_type_t1&direction=${direction == 'desc' ? 'asc' : 'desc' }&search_type=${search_type }&search_word=${search_word }'">[🎦]웹뷰어ACCESS</span>
					</td>
					</tr>
					<tr height="0.1">
						<td colspan="14">
